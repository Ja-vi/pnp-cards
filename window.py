...
#
# Created: Thu Jul 28 18:39:17 2016
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.fichero_edit.setGeometry(QtCore.QRect(90, 30, 111, 31))
        ...
        self.elegir_boton.setGeometry(QtCore.QRect(10, 30, 71, 31))
        self.elegir_boton.setObjectName(_fromUtf8("elegir_boton"))
        self.reset_boton = QtGui.QPushButton(self.groupBox_2)
        self.reset_boton.setGeometry(QtCore.QRect(210, 30, 71, 31))
        self.reset_boton.setObjectName(_fromUtf8("reset_boton"))
        ...
        self.paper_size_combo = QtGui.QComboBox(self.groupBox)
        self.paper_size_combo.setGeometry(QtCore.QRect(170, 30, 51, 31))
        self.paper_size_combo.setObjectName(_fromUtf8("paper_size_combo"))
        self.paper_size_combo.addItem(_fromUtf8(""))
        self.paper_size_combo.addItem(_fromUtf8(""))
        self.paper_size_combo.addItem(_fromUtf8(""))
        self.paper_size_combo.addItem(_fromUtf8(""))
        self.paper_size_combo.addItem(_fromUtf8(""))
        ...
        self.format_combo.setGeometry(QtCore.QRect(10, 30, 151, 31))
        self.format_combo.setObjectName(_fromUtf8("format_combo"))
        self.format_combo.addItem(_fromUtf8(""))
        self.format_combo.addItem(_fromUtf8(""))
        self.format_combo.addItem(_fromUtf8(""))
        self.card_size_combo = QtGui.QComboBox(self.groupBox)
        self.card_size_combo.setGeometry(QtCore.QRect(340, 30, 151, 31))
        self.card_size_combo.setObjectName(_fromUtf8("card_size_combo"))
        self.card_size_combo.addItem(_fromUtf8(""))
        self.card_size_combo.addItem(_fromUtf8(""))
        self.card_size_combo.addItem(_fromUtf8(""))
        self.card_size_combo.addItem(_fromUtf8(""))
        self.card_size_combo.addItem(_fromUtf8(""))
        ...
        self.card_size_combo.addItem(_fromUtf8(""))
        self.card_size_combo.addItem(_fromUtf8(""))
        self.orientation_combo = QtGui.QComboBox(self.groupBox)
        self.orientation_combo.setGeometry(QtCore.QRect(230, 30, 101, 31))
        ...
        self.preview_slider.setGeometry(QtCore.QRect(20, 430, 211, 20))
        ...
        self.preview_view = QtGui.QGraphicsView(self.groupBox_8)
        self.preview_view.setGeometry(QtCore.QRect(10, 30, 261, 381))
        ...
        self.left_crop = QtGui.QPushButton(self.groupBox_10)
        self.left_crop.setGeometry(QtCore.QRect(100, 50, 51, 41))
        self.left_crop.setObjectName(_fromUtf8("left_crop"))
        self.top_crop = QtGui.QPushButton(self.groupBox_10)
        self.top_crop.setGeometry(QtCore.QRect(160, 30, 61, 21))
        self.top_crop.setObjectName(_fromUtf8("top_crop"))
        self.right_crop = QtGui.QPushButton(self.groupBox_10)
        self.right_crop.setGeometry(QtCore.QRect(230, 50, 51, 41))
        self.right_crop.setObjectName(_fromUtf8("right_crop"))
        self.bottom_crop = QtGui.QPushButton(self.groupBox_10)
        self.bottom_crop.setGeometry(QtCore.QRect(160, 60, 61, 31))
        self.bottom_crop.setObjectName(_fromUtf8("bottom_crop"))
        self.all_crop = QtGui.QPushButton(self.groupBox_10)
        self.all_crop.setGeometry(QtCore.QRect(10, 70, 81, 21))
        self.all_crop.setFlat(False)
        self.all_crop.setObjectName(_fromUtf8("all_crop"))
        ...
        self.line_8.setGeometry(QtCore.QRect(10, 470, 881, 20))
        self.line_8.setFrameShape(QtGui.QFrame.HLine)
        self.line_8.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_8.setObjectName(_fromUtf8("line_8"))
        self.progress_bar = QtGui.QProgressBar(Form)
        self.progress_bar.setGeometry(QtCore.QRect(320, 490, 571, 20))
        ...
        self.paper_size_combo.setCurrentIndex(4)
        self.format_combo.setCurrentIndex(0)
        self.card_size_combo.setCurrentIndex(3)
    ...
    def retranslateUi(self, Form):
        ...
        self.fichero_edit.setPlaceholderText(QtGui.QApplication.translate("Form", "Imported files", None, QtGui.QApplication.UnicodeUTF8))
        self.elegir_boton.setText(QtGui.QApplication.translate("Form", "Load", None, QtGui.QApplication.UnicodeUTF8))
        self.reset_boton.setText(QtGui.QApplication.translate("Form", "Reset", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.paper_size_combo.setItemText(0, QtGui.QApplication.translate("Form", "A0", None, QtGui.QApplication.UnicodeUTF8))
        self.paper_size_combo.setItemText(1, QtGui.QApplication.translate("Form", "A1", None, QtGui.QApplication.UnicodeUTF8))
        self.paper_size_combo.setItemText(2, QtGui.QApplication.translate("Form", "A2", None, QtGui.QApplication.UnicodeUTF8))
        self.paper_size_combo.setItemText(3, QtGui.QApplication.translate("Form", "A3", None, QtGui.QApplication.UnicodeUTF8))
        self.paper_size_combo.setItemText(4, QtGui.QApplication.translate("Form", "A4", None, QtGui.QApplication.UnicodeUTF8))
        self.paper_size_combo.setItemText(5, QtGui.QApplication.translate("Form", "A5", None, QtGui.QApplication.UnicodeUTF8))
        self.paper_size_combo.setItemText(6, QtGui.QApplication.translate("Form", "A6", None, QtGui.QApplication.UnicodeUTF8))
        self.format_combo.setItemText(0, QtGui.QApplication.translate("Form", "Pdf from images", None, QtGui.QApplication.UnicodeUTF8))
        self.format_combo.setItemText(1, QtGui.QApplication.translate("Form", "Pdf from grid", None, QtGui.QApplication.UnicodeUTF8))
        self.format_combo.setItemText(2, QtGui.QApplication.translate("Form", "Separated images", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(0, QtGui.QApplication.translate("Form", "Jumbo (3.5\" w : 5.5\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(1, QtGui.QApplication.translate("Form", "Tarot (2.75\" w : 4.75\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(2, QtGui.QApplication.translate("Form", "Square (3.5\" w : 3.5\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(3, QtGui.QApplication.translate("Form", "Poker (2.5\" w : 3.5\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(4, QtGui.QApplication.translate("Form", "Bridge (2.25\" w : 3.5\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(5, QtGui.QApplication.translate("Form", "Biz (2\" w : 3.5\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(6, QtGui.QApplication.translate("Form", "Mini (1.75\" w : 2.5\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.card_size_combo.setItemText(7, QtGui.QApplication.translate("Form", "Micro (1.25\" w : 1.75\" l)", None, QtGui.QApplication.UnicodeUTF8))
        self.orientation_combo.setItemText(0, QtGui.QApplication.translate("Form", "Portrait", None, QtGui.QApplication.UnicodeUTF8))
        self.orientation_combo.setItemText(1, QtGui.QApplication.translate("Form", "Landscape", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.left_crop.setText(QtGui.QApplication.translate("Form", "Left", None, QtGui.QApplication.UnicodeUTF8))
        self.top_crop.setText(QtGui.QApplication.translate("Form", "Top", None, QtGui.QApplication.UnicodeUTF8))
        self.right_crop.setText(QtGui.QApplication.translate("Form", "Right", None, QtGui.QApplication.UnicodeUTF8))
        self.bottom_crop.setText(QtGui.QApplication.translate("Form", "Bottom", None, QtGui.QApplication.UnicodeUTF8))
        self.all_crop.setText(QtGui.QApplication.translate("Form", "All", None, QtGui.QApplication.UnicodeUTF8))
